          ...
          <div className="space-y-8">
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
                  ...
                  <label
                    ...
                    className="flex aspect-square cursor-pointer flex-col items-center justify-center rounded-md border border-dashed bg-muted text-muted-foreground hover:bg-muted/80"
                  >
                ...
                <p className="text-xs text-muted-foreground">
                  Upload up to 8 images. The first image will be the featured image.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Optional details about your product
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <FormField
